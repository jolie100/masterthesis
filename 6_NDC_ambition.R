...
ndcs_international_ambition <- ndcs_international %>%
  ...
  select(ISO, ghg_target, ghg_target_type_label, reference_base_year_label, time_target_year_label, conditionality_label) 
...
targets_nationalEU <- targets_nationalEU %>%
  ...
  select(alpha.3, Year, `Law/Policy`, ghg_target) 
